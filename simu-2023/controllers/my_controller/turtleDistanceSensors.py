...
class TurtleDistanceSensor(DistanceSensor):
    def __init__(self, name):
        DistanceSensor.__init__(self, name)
        self.enable(DISTANCE_SENSIOR_SAMPLING_PERIOD)

class TurtleDistanceSensors():
    DISTANCE_THRESHOLD = 78

    def __init__(self):
        self.__front_left = TurtleDistanceSensor('ps7')
        self.__front_left2 = TurtleDistanceSensor('ps6')
        self.__front_right = TurtleDistanceSensor('ps0')
        self.__front_right2 = TurtleDistanceSensor('ps1')
